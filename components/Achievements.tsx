...
import { Clock, Target, Medal, Zap, Book, Library, Trophy, CheckCircle2, Lock } from 'lucide-react';
import { Session, Subject, Achievement } from '../types';
...
const Achievements: React.FC<AchievementsProps> = ({ sessions, subjects, streak }) => {
            ...
            {unlockedAchievements.map(achievement => (
              ...
              >
                <div className="achievement-icon-box">
                  {React.isValidElement(achievement.icon) && React.cloneElement(achievement.icon, { 
